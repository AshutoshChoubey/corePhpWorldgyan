    ...
    if($result>=1)
        {
            ...
            echo "<script language=\"javascript\">location.href=\"UserIdAndPasswordResistration.php\"</script>";
...
<form  method="POST" name="frmPersonal">
    ...
    <table bgcolor=#FFFFFF style="height: 500px;" border=0>
        <tr><td valign="top" class="lefta"><input type="button" value="Add personal Detail" class="SelectedButton"  onclick="location.href='AddPersonalDetail.php'" /></td><td style="width: 5px;"></td><td rowspan="2"class="centerLine"></td></tr>
        ...
        if(TwelveSel=='Diploma')
     {
       ...
       if(TenthLeavingDate>TwelveJoiningDate)
      {
        ...
        return false;
         ...
         if(TwelveLeavingDate=='')
              {
                alert("please  Enter Leaving Year of Diploma degree   ");
                TwelveLeavingDateobj.focus();
                TwelveLeavingDateobj.selected();
              }
