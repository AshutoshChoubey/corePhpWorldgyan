...
<form name="FORMSTYLE" class="FORMSTYLE" method="POST">
    ...
    <table bgcolor=#FFFFFF style="height: 500px;" border=0>
      <tr><td valign="top" style="height: 30px;"><input type="button" value="Add personal Detail" class="clsbtnLeft"   onclick="location.href='frmAddPersonalDetailLogin.php'" /></td><td style="width: 5px;"></td><td rowspan="6"class="centerLine"></td></tr>
            ...
            <tr><td valign="top"><input type="button" value="Search" class="SelectedButton" onclick="location.href='frmSearch.php'"/></td></tr>
            
    </table></td>
    
    <td valign="top">
    <div style="background-color: #FAF9F9; width: 800px;">
        <table width="100%"  border=0 style="background-color: #BBD4F2;">
            <tr><td></td></tr>
        ...
        <table width="100%"  border="0" id="tabSearch">
   ...
   if($REQUEST_METHOD=='POST')
   {
    ?>
            <tr>
                ...
                <th style="background-color: #4A7AB8; color: white;">Employee Id</th>
                <th style="background-color: #4A7AB8; color: white;">Employee Name</th>
                <th style="background-color: #4A7AB8; color: white;">Father Name</th>
                <th style="background-color: #4A7AB8; color: white;">Nick Name</th>
                <th style="background-color: #4A7AB8; color: white;">Marital Status</th>
                <th style="background-color: #4A7AB8; color: white;">Mariage Date</th>
                <th style="background-color: #4A7AB8; color: white;">Email</th>
                <th style="background-color: #4A7AB8; color: white;">Website</th>
                <th style="background-color: #4A7AB8; color: white;">Blood Group</th>
                <th style="background-color: #4A7AB8; color: white;">Date of Birth</th>
                <th style="background-color: #4A7AB8; color: white;">Sex</th>
                <th style="background-color: #4A7AB8; color: white;">Pan</th>
                <th style="background-color: #4A7AB8; color: white;">Passport Number</th>
                <th style="background-color: #4A7AB8; color: white;">Permanent Address</th>
                <th style="background-color: #4A7AB8; color: white;">Residential Address</th>
                <th style="background-color: #4A7AB8; color: white;">Mobile Number</th>
                <th style="background-color: #4A7AB8; color: white;">Alternate Mobile Number</th>
            </tr>
            <?php
            }
            ?>
